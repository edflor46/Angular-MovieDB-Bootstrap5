// To parse this data:
//
//   import { Convert, SerieCredits } from "./file";
//
//   const serieCredits = Convert.toSerieCredits(json);
//
...
export class Convert {
    public static toSerieCredits(json: string): SerieCredits {
        return cast(JSON.parse(json), r("SerieCredits"));
    }

    public static serieCreditsToJson(value: SerieCredits): string {
        return JSON.stringify(uncast(value, r("SerieCredits")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Cast": o([
        ...
        { json: "profile_path", js: "profile_path", typ: "" },
