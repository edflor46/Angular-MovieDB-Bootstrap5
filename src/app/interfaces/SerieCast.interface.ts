// To parse this data:
//
//   import { Convert, SerieCast } from "./file";
//
//   const serieCast = Convert.toSerieCast(json);
//
...
export class Convert {
    public static toSerieCast(json: string): SerieCast {
        return cast(JSON.parse(json), r("SerieCast"));
    }

    public static serieCastToJson(value: SerieCast): string {
        return JSON.stringify(uncast(value, r("SerieCast")), null, 2);
    }
}
